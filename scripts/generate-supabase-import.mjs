...
function repairMojibake(value) {
  const manualFixes = [
    [/mec�nicos/g, "mecânicos"],
    [/mec�nico/g, "mecânico"],
    [/Mec�nico/g, "Mecânico"],
    [/escrit�rio/g, "escritório"],
    [/conex�o/g, "conexão"],
    [/ilumina��o/g, "iluminação"],
    [/multim�dia/g, "multimídia"],
    [/precis�o/g, "precisão"],
    [/digita��o/g, "digitação"],
    [/padr�o/g, "padrão"],
    [/op��o/g, "opção"],
    [/pr�tica/g, "prática"],
    [/m�os/g, "mãos"],
    [/Imped�ncia/g, "Impedância"],
    [/�udio/g, "áudio"],
    [/�ngulo/g, "Ângulo"],
    [/vis�o/g, "visão"],
    [/178�/g, "178°"],
    ...
    [/m�vel/g, "móvel"],
    [/met�lica/g, "metálica"],
    [/respir�vel/g, "respirável"],
    [/panor�mico/g, "panorâmico"],
    [/� 10%/g, "± 10%"],
    [/� 15%/g, "± 15%"],
    [/64 � 15%/g, "64 ± 15%"],
    [/17 � 15/g, "17 ± 15"],
